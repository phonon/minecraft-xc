...
/**
 * Component for periodic particle effects depending on vehicle condition.
 */
public data class ParticlesComponent(
    ...
    val tickPeriod: Int = 2,
): VehicleComponent<ParticlesComponent> {
    override val type = VehicleComponentType.PARTICLES
    ...
    override fun deepclone(): ParticlesComponent {
        return this.copy()
    }
    
    companion object {
        @Suppress("UNUSED_PARAMETER")
        public fun fromToml(toml: TomlTable, _logger: Logger? = null): ParticlesComponent {
            ...
            return mapToObject(properties, ParticlesComponent::class)
        }
    }
}